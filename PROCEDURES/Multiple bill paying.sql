DELIMITER $$
CREATE PROCEDURE PR_BILL_PAY(IN ORDERED_ID INT,IN  ITEM_LIST MEDIUMTEXT)
BEGIN
...
SET NEXT_ITEM = TRIM(ITEMS_NAME);
 /*TO CALL SINGLE ORDER bill pay PROCEDURE*/ 
 CALL  PR_BILL_DETAILS(ORDERED_ID,ITEMS_NAME);
